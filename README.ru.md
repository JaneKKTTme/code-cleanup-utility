...
- [Помогите, я всё удалил!](#помогите-я-всё-удалил)
...
### <a id="поддерживаемые-типы-файлов"></a> 🎯 Поддерживаемые типы файлов
...
### <a id="функции-безопасности"></a> 🛡️ Функции безопасности
...
## <a id="алгоритм-работы"></a> 🎪 Алгоритм работы
...
## <a id="использование"></a> 🚀 Как использовать?
...
## <a id="конфигурация"></a> ⚙️ Настройка
...
## <a id="помогите-я-всё-удалил"></a> 🆘 Помогите, я всё удалил!
**Первое:** Паника! 🚨
